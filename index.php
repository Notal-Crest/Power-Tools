    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-12">
            <p>
            In the past few years we have built many Websites, and Web applications, with a focus on JavaScript, ES6 and Responsive Design and PHP. Our core ability is complete engineering of Websites and Web Applications from the ground up, choosing an appropriate database, logic, and UI technologies from the array of existing options. we have taken part in different interesting projects and got an extensive experience in development and maintenance of Softwares, recieving a 5 STAR review for our performance. We are Devoted, Eager and Passionate to Gratify.
            </p>
          </div>
        </div>
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">What Development RoadMap Do You Recommend<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>House No: 0251, Angwan-Sariki Orozo, Abuja, Nigeria.</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>info@notalcrest.com.ng</p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+2348108929992, +2349022333202</p>
              </div>
